...
Observation and Geoinformatics Division, 1758 Avenida dos Astronautas,
Jardim da Granja, São José dos Campos, São Paulo, Brazil, 12227-010}
    \affiliation[Federal University of ABC (UFABC)]{Center for
Engineering, Modeling and Applied Social Sciences (CECS), 5001 Avenida
dos Estados, Bangu, Santo André, São Paulo, Brazil, 09210-580}
    \affiliation[McMaster University]{School of Earth, Environment \&
Society, 1280 Main Street, West, Hamilton, Ontario, Canada, ON L8S4L8}
...
\subsection{2.5. Classification Model}\label{classification-model}}
...
\section{4. STUDY LIMITATIONS}\label{study-limitations}}
