...
#' In order to obtain this classification, we used the mean-shift algorithm to segment an orthorectified image from the Wide Scan Multispectral and Panchromatic Camera (WPM) of the China-Brazil Earth Resources Satellite (CBER4-A), dated 07/31/2020 (path: 215, row: 117).
...
#' In order to obtain this classification, we used the mean-shift algorithm to segment an orthorectified image from the Wide Scan Multispectral and Panchromatic Camera (WPM) of the China-Brazil Earth Resources Satellite (CBER4-A), dated 09/15/2020 (path: 212, row: 116).
#' The WMP-CBERS image has 2 m spatial resolution for the panchromatic camera and 8 m for the multispectral camera. After segmentation, we extracted each segment's spectral, Grey-Level Co-occurrence Matrix texture measurements (GLCM), biophysical index, and geometry attributes.
...
#' The polygons were classified into: “Shrub Vegetation” (VA), “Herbaceous Vegetation” (VH), “Water” (AG), “Exposed Ground” (SE), “High Gloss Cover” (BR), “Ceramic Cover” (TC), “Fiber Cement Cover” (TF), “Asphalt Road” (AS), “Terrain Road” (ES), “Cloud” (NU) and “Shadow” (SO).
#'
#' @format A simple features data frame with 47,834 rows and 27 variables:
#'
#' \describe{
#'   \item{ID}{Unique identifier for each polygon in the data frame.}
...
#'   \item{B2_homogen}{Skewness value of the red band for all pixels inside the object.}
#'   \item{B2_skewnes}{Standard Deviation of the red band for all pixels inside the object.}
...
#' Urban Land Cover for the City of Maraba - Para State, Brazil (year of 2020)
#'
#' A simple features data frame with the features and the land cover classification for Maraba
#' In order to obtain this classification, we used the mean-shift algorithm to segment an orthorectified image from the Wide Scan Multispectral and Panchromatic Camera (WPM) of the China-Brazil Earth Resources Satellite (CBER4-A), dated 08/20/2020 (path: 211, row: 120).
#' The WMP-CBERS image has 2 m spatial resolution for the panchromatic camera and 8 m for the multispectral camera. After segmentation, we extracted each segment's spectral, Grey-Level Co-occurrence Matrix texture measurements (GLCM), biophysical index, and geometry attributes.
...
#' The polygons were classified into: “Shrub Vegetation” (VA), “Herbaceous Vegetation” (VH), “Water” (AG), “Exposed Ground” (SE), “High Gloss Cover” (BR), “Ceramic Cover” (TC), “Fiber Cement Cover” (TF), “Asphalt Road” (AS), “Terrain Road” (ES), “Cloud” (NU) and “Shadow” (SO).
#'
#' @format A simple features data frame with 465,545 rows and 17 variables:
#'
#' \describe{
#'   \item{ID}{Unique identifier for each polygon in the data frame.}
#'   \item{ASM_min}{Minimum value of the Angular Second Moment (ASM, also called Uniformity). This is a measure of local homogeneity. Calculated over a moving window of 25x25 pixels, isotropically.}
...
#'   \item{B3_mean}{Average value of the near-infrared band for all pixels inside the object.}
#'   \item{BAIN_std}{Standard Deviation of the Bare soil area index (near-infrared version): the normalized division of the blue band by the near-infrared band.}
#'   \item{CONTR_mean}{Average value of the Constrast. This measure analyses the image contrast (locally gray-level variations) as the linear dependency of grey levels of neighboring pixels (similarity). Calculated over a moving window of 25x25 pixels, isotropically.}
#'   \item{CONTR_std}{Standard Deviation of the Constrast. This measure analyses the image contrast (locally gray-level variations) as the linear dependency of grey levels of neighboring pixels (similarity). Calculated over a moving window of 25x25 pixels, isotropically.}
#'   \item{ENTR_mean}{Average value of the Entropy. This measure analyses the randomness. It is high when the values of the moving window have similar values. Calculated over a moving window of 25x25 pixels, isotropically.}
#'   \item{NDVI_mean}{Average value of the Normalized difference vegetation index: the normalized division of the near-infrared band by the red band.}
#'   \item{NDVI_std}{Standard Deviation of the Normalized difference vegetation index: the normalized division of the near-infrared band by the red band.}
...
#' In order to obtain this classification, we used the mean-shift algorithm to segment an orthorectified image from the Wide Scan Multispectral and Panchromatic Camera (WPM) of the China-Brazil Earth Resources Satellite (CBER4-A), dated 11/09/2020 (path: 219, row: 116).
#' The WMP-CBERS image has 2 m spatial resolution for the panchromatic camera and 8 m for the multispectral camera. After segmentation, we extracted each segment's spectral, Grey-Level Co-occurrence Matrix texture measurements (GLCM), biophysical index, and geometry attributes.
...
#' The polygons were classified into: “Shrub Vegetation” (VA), “Herbaceous Vegetation” (VH), “Water” (AG), “Exposed Ground” (SE), “High Gloss Cover” (BR), “Ceramic Cover” (TC), “Fiber Cement Cover” (TF), “Asphalt Road” (AS), “Terrain Road” (ES), “Cloud” (NU) and “Shadow” (SO).
#'
#' @format A simple features data frame with 65,822 rows and 38 variables:
#'
#' \describe{
#'   \item{ID}{Unique identifier for each polygon in the data frame.}
...
#'   \item{B0_var}{Variance value of the blue band for all pixels inside the object.}
#'   \item{B2_contr}{Contrast of the red band for all pixels inside the object. It returns a measure of the intensity contrast between a pixel and its southeast neighbor over the object. Contrast is 0 for a constant object.}
#'   \item{B3_max}{Maximum value of the red band for all pixels inside the object.}
#'   \item{B3_mean}{Average value of the near-infrared band for all pixels inside the object.}
#'   \item{B3_min}{Minimun value of the near-infrared band for all pixels inside the object.}
#'   \item{BAI_var}{Variance of the Bare soil area index: the normalized division of the blue band by the near-infrared band.}
#'   \item{COR_sum}{Sum value of the Constrast. This measure analyses the linear dependency of grey levels of neighboring pixels. Typically high, when the scale of local texture is larger than the distance. Calculated over a moving window of 3x3 pixels, isotropically.}
...
#'   \item{NDVI_range}{Range value of the Normalized difference vegetation index: the normalized division of the near-infrared band by the red band. The range means the maximum pixel value minus the minimum pixel value.}
...
#'   \item{NDWI_var}{Variance value of the Normalized difference water index: the normalized division of the green band by the near-infrared band.}
#'   \item{Road_perc}{Ratio of the length of roads in each polygon to the area of the polygon. The roads were obtained from open street maps.}
...
#'   \item{SV_var}{Variance value of the Sum Variance. Calculated over a moving window of 3x3 pixels, isotropically.}
#'   \item{TARGET}{Variable related to the sampling process. Null value means that the feature was not selected during sampling.}
#'   \item{CLASS}{The land cover class in which the polygon belongs.}
#'   \item{geometry}{geometry of the simple features.}
#' }
