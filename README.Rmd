...
The maps have the following land cover classes: "Shrub Vegetation" (VA), "Herbaceous Vegetation" (VH), "Water" (AG), "Exposed Ground" (SE), "High Gloss Cover" (BR), "Ceramic Cover" (TC), "Fiber Cement Cover" (TF), "Asphalt Road" (AS), "Terrain Road" (ES), "Cloud" (NU) and "Shadow" (SO).
